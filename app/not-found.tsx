...
export default function NotFound() {
  return (
    <div className="flex min-h-[55vh] flex-col items-start justify-center md:flex-row md:items-center md:space-x-6">
      ...
      <div className="max-w-md">
        <p className="mb-4 text-xl leading-normal font-bold md:text-2xl">没有找到这个页面</p>
        <p className="mb-8 text-slate-600 dark:text-slate-400">
          页面可能已调整，请返回首页或使用顶部搜索查找论文内容。
        </p>
        <Link
          href="/"
