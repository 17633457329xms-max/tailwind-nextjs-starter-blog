...
export const metadata = genPageMetadata({
  title: '关于青衿学长讲论文',
  description: '了解青衿学长讲论文网站的内容方向、更新原则、研究辅导与论文润色优化方式。',
})
...
export default function AboutPage() {
  const profileJsonLd = {
    ...
    mainEntity: {
      ...
      description: '青衿学长讲论文网站维护者，持续整理经管论文研究方法、Stata代码与写作润色内容。',
  ...
  return (
    <div className="pt-8 sm:pt-10">
      ...
      <PageHero
        ...
        description="青衿学长讲论文面向国内外经管学生，持续整理选题、文献、变量数据、实证方法、Stata代码、论文写作与润色优化内容，并提供一对一问题诊断入口。"
        actions={
          <Link
            href="/contact"
      ...
      <section className="grid gap-8 py-12 lg:grid-cols-[0.75fr_1.25fr]">
        <aside className="rounded-3xl border border-slate-200 bg-white p-7 dark:border-slate-800 dark:bg-slate-900">
          <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-[#123f46] text-3xl font-black text-white">
            青
          </div>
          <h2 className="mt-5 text-2xl font-black">青衿学长</h2>
          <p className="mt-2 text-sm text-slate-500">青衿学长讲论文 · 网站维护者</p>
        ...
        <div className="space-y-6">
          {[
            [
              '内容怎么产生',
              '面向国内外经管学生整理高频问题；每篇页面先定义问题，再说明判断条件、操作步骤、常见错误和继续阅读路径。',
            ],
            [
              '内容如何核验',
